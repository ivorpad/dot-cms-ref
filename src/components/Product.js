    ...
    useEffect(() => {
      const fetchProductById = async () => {
        const product = await fetch(
          `https://demo.dotcms.com/api/content/render/false/type/json/query/-contentType:forms%20+contentType:Product%20+(conhost:48190c8c-42c4-46af-8d1a-0cd5db894797%20conhost:SYSTEM_HOST)%20+(Product.productNumber:*${id}*%20Product.productNumber_dotraw:*${id}*)%20+languageId:1%20+deleted:false%20+working:true/orderby/score,modDate%20desc`
